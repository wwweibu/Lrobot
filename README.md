...
- [x] **更新 bili 和 wechat 的多种消息处理**
- [x] **重新解析lr5921的消息返回值（200不一定成功）**
- [x] **LR232使用发送1、2、3的机制来回复同一消息(分开发送同一条消息)**
- [x] **~~msg_get 返回消息段数组，需要更改函数~~**
- [x] **~~小程序发送消息数组，但消息内容必须是str~~**
- [ ] **LR232 也增加媒体缓存**
- [ ] **用 [markdown-it](https://markdown-it.docschina.org/#%E8%AF%AD%E6%B3%95%E6%8B%93%E5%B1%95)更新社团 wiki
- [ ] **用单状态多信息、单命令代替航海日记里的多命令多状态**
- [ ] **等微信官方解决 \n 无法发送的问题**
- [ ] **需要解析 LR5921 的 msg_sent 类型消息以获取包剪锤的自身结果**
- [ ] **消息池添加 keep 字段**
